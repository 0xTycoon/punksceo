...
describe("Migration", function () {
    ...
    describe("Deployment", function () {
        ...
        it("trigger migration", async function () {
            ...
            expect(await cig.migrationComplete()).to.emit(nft, "Transfer").withArgs(burner, "0x1e32a859d69dde58d03820F8f138C99B688D132F", 0); // make sure the NFT was transferred
