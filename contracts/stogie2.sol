...
contract Stogie2 {
    ...
    * STOG staking
    */
    uint256 public _accCigPerShare; // Accumulated cigarettes per share, times 1e12.
    ...
    * @return cigReward - the amount of CIG that was credited to this contract's
    *   reserves
    */
    ...
    */
    ...
    /** todo test
    * Fill the contract with additional CIG for rewards, adding CIG to the
    *    reserves which then get filled
    */
    ...
    function _fill(uint256 _amount) internal {
        treasury += _amount;
    ...
    */
    function pendingCig(address _user) view public returns (uint256) {
        ...
        uint256 pending = cig.pendingCig(address(this)) *
            (user.deposit * 1e12 / supply) / 1e12;           // _user's portion of pending CIG
